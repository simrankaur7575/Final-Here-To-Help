package com.example.heretohelp.Service;
...
import com.example.heretohelp.OrderStatus;
import com.example.heretohelp.R;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        builder.setAutoCancel(true)
                ...
                .setContentText("Request #"+key+ " status was updated to "+ Common.convertCodeToStatus(request.getStatus()))
